...
{
System.out.println("Usage: java classspath path_to_jar;. com.thinking.machines.util.SetterGetterGenerator class_name constructor=true/false");
return;
}
if(gg.length==2)
{
if(gg[1].equalsIgnoreCase("construcotr=true")==false && gg[1].equalsIgnoreCase("constructor=false")==false)
{
System.out.println("Usage: java classspath path_to_jar;. com.thinking.machines.util.SetterGetterGenerator class_name constructor=true/false");
return;
}
...
String setterName, getterName, tmp, fieldName, line;
Class fieldType;
...
line="this."+field.getName()+"="+getDefaultValue(fieldType)+";";
list.add(line);
}
list.add("}");
}
...
System.out.println("Setter/Getters for: "+c.getName()+" generated in file name tmp.tmp");
